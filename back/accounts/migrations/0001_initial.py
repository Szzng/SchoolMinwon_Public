    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('PARENT', '학부모'), ('TEACHER', '교사'), ('ADMIN', '관리자')], default='PARENT', max_length=20)),
                ('phone', models.CharField(blank=True, max_length=20, verbose_name='연락처')),
                ('school_name', models.CharField(blank=True, max_length=100, verbose_name='소속 학교')),
